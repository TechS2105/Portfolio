                ...
                <div className={ContactStyle.contactInformationContainer}>
                    ...
                    <div className={ContactStyle.contactForm}>
                        ...
                        <form action="#">
                            ...
                            <textarea id="textarea" cols={53} rows={8} required></textarea><br/><br/>
